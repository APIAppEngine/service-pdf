...
public class OptimizeController
{
    ...
    {
        return executeJob(null, documentId, algo, hscale, noattachments, nobookmarks, nocomments, nofonts, nojavascripts, nolinks, nometadata, nothumbnails, pages, password, vscale);
    }
