...
import apiserver.workers.coldfusion.services.pdf.ExtractImageCallable;
 ...
 * Date: 9/18/12
 */
public class ExtractPdfImagesCFService extends GridService implements Serializable
{
    ...
    public Object execute(Message<?> message) throws ColdFusionException
    {
        ...
        try
        {
            ...
            Future<CollectionResult> future = exec.submit(
                    new ExtractImageCallable(props.getFile().getFileBytes(), props.getOptions())
            );
