...
import apiserver.workers.coldfusion.services.pdf.ProcessDDXCallable;
 ...
 * Date: 9/18/12
 */
public class ProcessPdfDDXCFService extends GridService implements Serializable
{
    ...
    public Object execute(Message<?> message) throws ColdFusionException
    {
        ...
        try
        {
            ...
            Future<ByteArrayResult> future = exec.submit(
                    new ProcessDDXCallable(props.getFile().getFileBytes(), props.getDdx())
            );
