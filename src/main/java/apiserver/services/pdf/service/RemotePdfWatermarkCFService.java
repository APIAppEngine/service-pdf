...
import apiserver.workers.coldfusion.services.pdf.RemoveWatermarkCallable;
 ...
 * Date: 9/18/12
 */
public class RemotePdfWatermarkCFService extends GridService implements Serializable
{
    ...
    public Object execute(Message<?> message) throws ColdFusionException
    {
        ...
        try
        {
            ...
            Future<ByteArrayResult> future = exec.submit(
                    new RemoveWatermarkCallable(props.getFile().getFileBytes(), props.getOptions())
            );
