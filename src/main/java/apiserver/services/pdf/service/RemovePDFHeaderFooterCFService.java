...
import apiserver.workers.coldfusion.services.pdf.RemoveHeaderFooterCallable;
 ...
 * Date: 9/18/12
 */
public class RemovePdfHeaderFooterCFService extends GridService implements Serializable
{
    ...
    public Object execute(Message<?> message) throws ColdFusionException
    {
        ...
        try
        {
            ...
            Future<ByteArrayResult> future = exec.submit(
                    new RemoveHeaderFooterCallable(props.getFile().getFileBytes(), props.getOptions())
            );
